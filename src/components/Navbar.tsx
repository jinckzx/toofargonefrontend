        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="absolute right-4">
              <Link
                to="/cart"
                className="flex items-center justify-center text-sm font-HelveticaCustom font-bold hover:text-black transition-colors px-4 py-1 rounded"
              >
                <span>Cart</span>
                <span className="ml-2 bg-black text-white text-xs w-5 h-5 rounded-full flex items-center justify-center">
                  0
                </span>
              </Link>
            </div>
